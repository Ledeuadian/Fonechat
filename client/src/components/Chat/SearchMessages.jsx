...
function SearchMessages() {
  ...
  return (
    <div className="border-conversation-border border-1 w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen">
      <div className="h-16 px-4 py-5 flex gap-10 items-center bg-panel-header text-primary-strong" >
        <IoClose 
      ...
      <div className="overflow-auto custom-scrollbar h-full">
        ...
        <div className="flex justify-center h-full flex-col">
          ...
          <div className="flex flex-col w-full h-full">
            { searchedMessages.map((message, preventErrorPurpose) => (
              <div className="flex cursor-pointer flex-col justify-center hover:bg-background-default-hover w-full px-5 border-b-[0.1px] border-secondary py-5" key={preventErrorPurpose}>
